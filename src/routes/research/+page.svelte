...
<svelte:head>
    <title>Pierre-Paul De Breuck | Research</title>
    <meta
        name="description"
        content="Pierre-Paul De Breuck. Explore my research interests"
    />
</svelte:head>
...
<div class="row">
    ...
    <div class="col-10">
        ...
        <ul>
            <li>
                <a href="https://matra.pierrepauldb.com/">Matra-Genoa App</a> A web
                app for generating new crystal structures.
            </li>
            <li>
                <a href="https://github.com/ppdebreuck/modnet"
                    ><img
                        src="/modnet-logo-01.svg"
                        alt="modnet-logo"
                        width="150"
                    /></a
            ...
            <li>
                <a href="https://plasticity.modl-uclouvain.org"
                    ><img
                        src="/ppapp.svg"
                        alt="PPApp-logo"
                        width="100"
                        class=""
                    /> Plasticty Predictor App</a
                > A simple web application for predicting the joint activation of
                the TRIP and TWIP effects in Titanium alloys for improved work hardening.
            </li>
            <li>
                <a href="https://b2.modl-uclouvain.org/all-ternary-plots"
                    >B2 Predictor App</a
                > A simple web app for predicting the probability of B2-phase crystallization.
            </li>
        </ul>
    </div>
    <div class="col-1"></div>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img
                ...
                src="/bootstrap.png"
                alt="Pierre-Paul De Breuck bootstrap method"
            />
        </div>
        <div class="carousel-item">
            <img
                class="d-block w-50 mx-auto"
                src="/moti.png"
                alt="Pierre-Paul De Breuck moti"
            />
        </div>
        <div class="carousel-item">
            <img
                ...
                style="height:250px;"
                src="/ref_index_PCA.png"
                alt="Pierre-Paul De Breuck PCA"
            />
        </div>
        <div class="carousel-item">
            <img
                class="d-block w-50 mx-auto"
                src="/titan_schematic_draft.png"
                alt="Pierre-Paul De Breuck plasiticty predictor"
            />
        </div>
        <button
